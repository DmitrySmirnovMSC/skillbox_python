...
secret_message_fourth_reverse = secret_message[3][::-1]
fourth_word_reverse = secret_message_fourth_reverse[-13:-7]

secret_message_fifth_message = secret_message[4][::-1]
fifth_word_reverse = secret_message_fifth_message[-21:-16]

print(first_word)
print(second_word)
print(third_word)
print(fourth_word_reverse)
print(fifth_word_reverse)
...
message = first_word + " " + second_word + " " + third_word + " " + fourth_word_reverse + " " + fifth_word_reverse
print(message)